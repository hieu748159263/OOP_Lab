...
public class days_in_a_month {
    ...
    static int get_month_number(String sMonth) {
        ...
        DateTimeFormatter numMonth = DateTimeFormatter.ofPattern("M"); // 1
        DateTimeFormatter abbMonth = DateTimeFormatter.ofPattern("MMM"); // Jan
        DateTimeFormatter fullMonth = DateTimeFormatter.ofPattern("MMMM"); // January
